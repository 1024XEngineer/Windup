...
DELAYED_ZSET_KEY = os.getenv("WINDUP_MQ_DELAYED_ZSET", "").strip() or "windup:zset:delayed"
DELAYED_CLAIM_LIMIT = _env_int("WINDUP_MQ_DELAYED_CLAIM_LIMIT", 50)
DELAYED_TICK_SECONDS = _env_int("WINDUP_MQ_DELAYED_TICK_SECONDS", 1)
