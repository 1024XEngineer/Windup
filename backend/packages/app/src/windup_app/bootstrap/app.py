...
from windup_app.server.art_style_preset import ART_STYLE_PRESETS
from windup_app.web.api.action_preset import router as action_preset_router
from windup_app.web.api.art_style import router as art_style_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(art_style_router)
    ...
    app.state.art_style_presets = ART_STYLE_PRESETS
