  ...
  function generateFirstFrame(
    ...
    return submitDirectionalGenerations(
      ...
      (run, node, direction) => {
        ...
        const characterTemplateReference =
          templateNode.selectedImages?.[direction] ?? templateNode.selectedImageUrl
  ...
  function generateCompleteAnimation(
    ...
    return submitDirectionalGenerations(
      ...
      (run, node, direction) => {
        ...
        const firstFrameUrl =
          firstFrameNode.selectedFirstFrameUrls?.[direction] ?? firstFrameNode.selectedFirstFrameUrl
