import type { Character, Frame } from "../../../entities/character";
      ...
      candidateCharacterTemplates: [
        {
          ...
          generationId: "playtest-demo-boy-import",
        },
      ],
      characterTemplateUrl: fixtureUrl("base.png"),
      baseFrames: [{ direction: "default", imageUrl: fixtureUrl("base.png") }],
      actions: [
        {
          ...
          status: "confirmed",
          fps: 8,
          sequences: [{ direction: "default", keyFrameIndex: 0, frames: idleFrames }],
        },
        {
          ...
          status: "confirmed",
          fps: 10,
          sequences: [{ direction: "default", keyFrameIndex: 0, frames: walkFrames }],
        },
      ],
    },
  ],
